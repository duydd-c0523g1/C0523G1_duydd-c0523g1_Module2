...
public class CustomerController {
    ...
    public static void main(String[] args) {
        // Thêm khách hàng
        clientsService.addCustomer(new Customer(1, "John Smith", 30, "Regular"));
        clientsService.addCustomer(new Customer(2, "Emma Johnson", 25, "VIP"));
        clientsService.addCustomer(new Customer(3, "Michael Brown", 40, "Regular"));
